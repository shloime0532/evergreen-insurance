      ...
      <div className="border-t border-white/10">
        <div className="mx-auto flex max-w-7xl flex-col items-center justify-between gap-2 px-6 py-6 sm:flex-row">
          <p className="text-sm text-white/50">
            &copy; 2026 Evergreen Insurance Group. All rights reserved.
          </p>
          <p className="text-sm text-white/50">Licensed in NJ, NY, PA</p>
        </div>
      </div>
    </footer>
  );
